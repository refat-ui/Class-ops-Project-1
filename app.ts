...
// Initialize Google Service Account details
...
// API Routes defined as reusable handlers
...
const dataHandler = async (req: express.Request, res: express.Response) => {
...
// Map routes with and without the /api prefix to support both direct routing and rewritten routing on Vercel
...
// Global Express Error Handler to prevent raw HTML crashes
